...
class Player:
    IMG = 0
    PLAYER_DIRECTIONS=[(0,2),(1,2),(0,3),(1,3),(2,2),(3,2),(2,3),(3,3)]
    WIDTH = 8
    HEIGHT = 8
    DX = 1
    ...
    def move_left(self): #Ma shala it works but not functionnalized hmmmmmm (g le seum)
        ...
        next_tile_bottom = (1,1) #explicé au prochain comm et au "and"
        ...
        if (
        (next_tile_up[1] >= 4 #si le block est de l'air
