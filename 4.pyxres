...
<!-- End Matomo Code -->    	<title>oups</title>
</head>
    <body>
        <div class="container">
            <div class="row mt-5">
                <div class="col text-center"><img src="https://www.nuitducode.net/img/nuitducode.svg" width="200" /></div>
            </div>
            <div class="row mt-3">
                <div class="col text-center text-uppercase" style="font-size:150%;color:#a0aec0">404 | Non trouvé</div>
            </div>
            <div class="row mt-5">
