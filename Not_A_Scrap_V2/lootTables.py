...
RARITY_TABLE = LootTable([[COMMON_TABLE,75,1], [RARE_TABLE,20,2], [LEGENDARY_TABLE,5,3]])
FUEL_TABLE = LootTable([[SMALL_FUEL(),75, 1], [MEDIUM_FUEL(),20,2], [BIG_FUEL(),5,3]])
...
HEAL_TABLE = LootTable([[COMMON_HEAL_TABLE, 75, 1], [RARE_HEAL_TABLE, 20, 1], [LEGENDARY_HEAL_TABLE, 5, 1]])
...
SUPPORT_TABLE = LootTable([[COMMON_SUPPORT_TABLE, 75, 1], [RARE_SUPPORT_TABLE, 20, 1], [LEGENDARY_SUPPORT_TABLE, 5, 1]])
...
DAMAGE_TABLE = LootTable([[COMMON_DAMAGE_TABLE, 75, 1], [RARE_DAMAGE_TABLE, 20, 1], [LEGENDARY_DAMAGE_TABLE, 5, 1]])